        ...
        return """
                ...
                <body>
                    <main>
                        ...
                        <p class="description">
                            This service manages volunteer actions, donation actions, contribution actions, and activism actions.
                        </p>
                        <section class="cards">
                            ...
                            <a class="card" href="/actions">
                                <strong>Actions API</strong>
                                <span>Open the main actions endpoint.</span>
                            </a>
                        </section>
                        <section class="info">
                            <h3>Service Info</h3>
                            <div class="info-grid">
                                <div class="info-item"><div class="label">Service name</div><div class="value">action-service</div></div>
                                <div class="info-item"><div class="label">Runtime</div><div class="value">Quarkus</div></div>
                                <div class="info-item"><div class="label">Port</div><div class="value">8082</div></div>
