    ...
    public String home() {
        return """
                ...
                <head>
                    ...
                    <title>Participation Service</title>
                    <style>
                    ...
                    <main>
                        <section class="top">
                            <div>
                                ...
                                <h2>Participation Service</h2>
                            </div>
                            <div class="badge"><span class="dot"></span>RUNNING</div>
                        </section>
                        <p class="description">
                            This service manages volunteer participations, registrations, and participation-related operations.
                        </p>
                        <section class="cards">
                            ...
                            <a class="card" href="/participations">
                                <strong>Participations API</strong>
                                <span>Open the main participation endpoint.</span>
                            </a>
                        </section>
                        <section class="info">
                            <h3>Service Info</h3>
                            <div class="info-grid">
                                <div class="info-item"><div class="label">Service name</div><div class="value">participation-service</div></div>
                                <div class="info-item"><div class="label">Runtime</div><div class="value">Quarkus</div></div>
                                <div class="info-item"><div class="label">Port</div><div class="value">8083</div></div>
